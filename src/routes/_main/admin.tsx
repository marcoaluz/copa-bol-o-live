...
const tiles = [
  { icon: Trophy, label: "Partidas", desc: "Gerenciar jogos e resultados" },
  { icon: Users, label: "Usuários", desc: "Lista de jogadores" },
  { icon: Shield, label: "Permissões", desc: "Controle de acesso" },
  { icon: Settings, label: "Configurações", desc: "Ajustes do bolão" },
];
  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        {tiles.map((t) => (
          <Card key={t.label} className="bg-card border-border rounded-xl p-5 shadow-card hover:border-gold/50 transition-colors cursor-pointer">
